...
public class PanelClients extends PanelPrincipal implements ActionListener {
    ...
    public PanelClients(String titre) {
        ...
        // Configuration du panel Formulaire
    ...
    public void deleteClient() {
        ...
        int retour = JOptionPane.showConfirmDialog(this, "Voulez vous supprimer ce client ?", 
    ...
    public void updateClient() {
        ...
        if (nom.equals("") || prenom.equals("") || email.equals("") || mdp.equals("") || 
            adresse.equals("") || cp.equals("") || ville.equals("") || tel.equals("") || RIB.equals("")) {
    ...
    public void insertClient() {
        ...
        if (nom.equals("") || prenom.equals("") || email.equals("") || mdp.equals("") || 
            ...
            Client unClient = new Client(nom, prenom, email, mdp, tel,"client", adresse, cp, ville, RIB);
