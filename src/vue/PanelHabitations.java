...
public class PanelHabitations extends PanelPrincipal implements ActionListener {
	...
	private static PanelMaisons unPanelMaisons = new PanelMaisons("Gestion des Maisons");
	private static PanelAppartements unPanelAppartements = new PanelAppartements("Gestion des Appartements");

	public PanelHabitations(String titre) {
		super(titre);
		
		this.panelForm.setBounds(300,35,400,40);
