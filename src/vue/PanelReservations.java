...
public class PanelReservations extends PanelPrincipal implements ActionListener  {
	...
	public PanelReservations(String titre) {
		super(titre);
		this.txtEtatRes.addItem("en demande");
		this.txtEtatRes.addItem("confirmée");
		...
		this.panelForm.add(this.txtRefHab);
	...
	public void updateReservation(){
		...
		String chaine = this.txtRefHab.getSelectedItem().toString();
		String tab[] = chaine.split("-");
		int refHab = Integer.parseInt(tab[0]);
		
		if(dateRes.equals("") || this.txtNbPerso.getText().isEmpty() || dateDebut.equals("") || dateFin.equals("") || 
				   etatRes.equals("") || this.txtIdC.getText().isEmpty() || this.txtRefHab.getSelectedItem().toString().isEmpty()) {
